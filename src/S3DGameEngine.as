	...
	public class S3DGameEngine {
		...
		public function update():void {
			...
			if (KB.is_key_down(Keyboard.LEFT) && !_last_left) {
				...
				attack_enemy_on_side(particle_spawn_pos, Enemy.SIDE_LEFT);
				...
				particle_spawn_pos = new Vector3D(_player.x+100, _player.y - 140,0);
				attack_enemy_on_side(particle_spawn_pos, Enemy.SIDE_RIGHT);
				...
				attack_enemy_on_side(particle_spawn_pos, Enemy.SIDE_UP);
		...
		public function attack_enemy_on_side(particle_spawn_pos:Vector3D, side:String): void {
