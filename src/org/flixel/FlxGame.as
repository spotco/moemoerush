package org.flixel
{
	...
	public class FlxGame extends Sprite
	{
		 ...
		 */
		public function FlxGame(GameSizeX:uint,GameSizeY:uint,InitialState:Class,Zoom:Number=1,GameFramerate:uint=60,FlashFramerate:uint=30,UseSystemCursor:Boolean=true)
		{
